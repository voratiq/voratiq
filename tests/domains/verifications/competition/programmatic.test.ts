...
import { executeAndPersistProgrammaticMethod } from "../../../../src/domains/verifications/competition/programmatic.js";
import type { VerificationRecordMutators } from "../../../../src/domains/verifications/model/mutators.js";
import { executeProgrammaticChecks } from "../../../../src/domains/verifications/programmatic/runner.js";
import {
...
jest.mock(
  "../../../../src/domains/verifications/programmatic/runner.js",
  () => {
    const actual = jest.requireActual<
      typeof import("../../../../src/domains/verifications/programmatic/runner.js")
    >("../../../../src/domains/verifications/programmatic/runner.js");
    return {
      ...actual,
      ...
      expect(runGitCommandMock).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          cwd: expect.stringContaining(
            "/.voratiq/verifications/sessions/verify-123/programmatic/reconstructed/agent-1-",
          ),
        }),
      );
  ...
  it("treats an empty retained diff as a valid no-op during reconstruction", async () => {
    ...
    try {
      ...
      expect(executeProgrammaticChecksMock).toHaveBeenCalledWith(
        expect.objectContaining({
          cwd: expect.stringContaining(
            "/.voratiq/verifications/sessions/verify-empty-diff/programmatic/reconstructed/agent-1-",
          ),
        }),
      );
      expect(removeWorktreeMock).toHaveBeenCalledTimes(1);

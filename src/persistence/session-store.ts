...
export interface SessionStoreConfig<RecordType, IndexEntry, StatusType> {
...
export function createSessionStore<RecordType, IndexEntry, StatusType>(
  config: SessionStoreConfig<RecordType, IndexEntry, StatusType>,
) {

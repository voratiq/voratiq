...
import { validateReductionOutputContract } from "./output-validation.js";
import { buildReducePrompt } from "./prompt.js";
import { parseReductionArtifact } from "./reduction.js";
import { composeReduceSandboxPolicy } from "./sandbox-policy.js";
...
async function rewriteOrAppendReductionRecord(options: {
  ...
  const { appendReductionRecord } = await import(
